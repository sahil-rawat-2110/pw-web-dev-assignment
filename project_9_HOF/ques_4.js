...
const books = [
  ...
  const filteredBooks = books.filter((el) => el.publicationyear > 2010).map((book) => ({
    name : book.name, author: book.author.toUpperCase(), publicationyear: book.publicationyear,
  }));
